...
var config = {
    ...
    entry: {
        'faker': [PATHS.entryPoint],
        'faker.min': [PATHS.entryPoint]
    },
    // The output defines how and where we want the bundles. The special
    // value `[name]` in `filename` tell Webpack to use the name we defined above.
    // We target a UMD and name it Faker. When including the bundle in the browser
    // it will be accessible at `window.Faker`
    output: {
        path: PATHS.bundles,
        filename: '[name].js',
        libraryTarget: 'umd',
